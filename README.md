...
|**팀원 1**|**팀원 2**|**팀원 3**|**팀원 4**|
|:----------:|:----------:|:----------:|:----------:|
|<img src="" width = 100 height = 100>|<img src = "agent/assets/1Asnf5J__400x400.jpg" width = 100 height = 100>|<img src = "agent/assets/KakaoTalk_20251025_112311228.png" width = 100 height = 100>|<img src = "agent/assets/KakaoTalk_20251024_180108077.jpg" width = 100 height = 100>|    
...
- 서선후: 이번 프로젝트를 통해 데이터가 단순한 분석 도구를 넘어 사람과 조직의 회복탄력성을 실질적으로 강화하는 수단이 될 수 있음을 확인했습니다. 소상공인의 회복력 진단과 리뷰 분석을 결합한 서비스를 기획하며 기술이 지속가능한 성장을 돕는 방향으로 쓰일 때 더 큰 의미를 가진다는 확신을 얻었습니다. 앞으로도 사람과 협력에 대한 관심을 바탕으러 변화에 흔들리지 않는 회복력 있는 사회를 만드는데 기여하고자 합니다.
